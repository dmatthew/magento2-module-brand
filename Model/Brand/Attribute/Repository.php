...
namespace Dmatthew\Brand\Model\Brand\Attribute;
 ...
 */
class Repository implements \Dmatthew\Brand\Api\BrandAttributeRepositoryInterface
{
    /**
     * @var \Dmatthew\Brand\Model\ResourceModel\Attribute
     */
    ...
    public function get($attributeCode)
    {
        return $this->eavAttributeRepository->get(
            \Dmatthew\Brand\Api\Data\BrandAttributeInterface::ENTITY_TYPE_CODE,
            $attributeCode
        );
    }
    ...
    public function save(\Dmatthew\Brand\Api\Data\BrandAttributeInterface $attribute)
    {
        if ($attribute->getAttributeId()) {
            ...
            $attribute->setEntityTypeId(
                $this->eavConfig
                    ->getEntityType(\Dmatthew\Brand\Api\Data\BrandAttributeInterface::ENTITY_TYPE_CODE)
                    ->getId()
            );
